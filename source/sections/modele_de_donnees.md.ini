...
exemple bordereau de transfert conforme au standard SEDA v.2.1,
...
Les bases contiennent différentes collections. Les collections peuvent
être rapprochées du concept de tables en SQL.
...
Certains champs ayant une cardinalité 1-1 sont directement renseignés
par la solution logicielle Vitam et sont donc obligatoirement présents
dans la base de données, mais ne le sont pas forcément dans les données
envoyées.
...
-   PID : identifiant de processus Unix.
    ...
    []{#__RefHeading___Toc29347_1669085364 .anchor}1.4.5. Dates
...
-   Peut être « VALID » si le certificat est valide, ou « REVOKED » s’il
    > est révoqué.
...
La collection PersonalCertificate permet de référencer et décrire
unitairement les certificats personnels utilisés pour l’authentification
de personae.
...
-   Journalisation externe (enregistrement d’opérations extérieures dans
    > la solution logicielle Vitam)

Les valeurs correspondant à ces opérations dans les journaux sont détaillées dans [l’annexe 6.3](#annexe-6-3-collection-eliminationactionobjectgroup)
...
La structure est décrite ci-dessous. Pour certains champs, on indiquera
s’il s’agit de la structure incluante ou d’une structure incluse dans
celle-ci.
...
-   La liste des valeurs possibles pour ce champ se trouve en annexe. Seul le code est stocké dans ce champ, la traduction se faisant via un fichier properties (vitam-logbook-message-fr.propertiesu.
...
-   Nom du processus, parmi une liste de processus possibles fixée. Cette liste est disponible en [l’annexe 6.3](#annexe-6-3-collection-eliminationactionobjectgroup) 
...
identifiant de la transaction qui a entraîné le lancement d’une opération dans la solution logicielle Vitam.
...
-   Il s’agit de la date de début de la précédente opération de sécurisation du même type réalisée un mois avant au format ISO8601i AAAA-MM-JJ+ »T »+hh:mm:ss: [3 digits de millisecondes].
...
-   Nom du fichier sécurisé sur les offres de stockage au format
    ...
    Exemple :
```
 "0\_LogbookOperation\_20170127\_141136.zip"
```
...
1.  []{#__RefHeading___Toc29445_1669085364 .anchor}5. Base MasterData
...
[]{#__RefHeading___Toc29451_1669085364 .anchor}5.1. Collection
AccessContract

[]{#__RefHeading___Toc29453_1669085364 .anchor}5.1.1. Utilisation de la
...
[]{#__RefHeading___Toc29455_1669085364 .anchor}5.1.2. Exemple d’un
...
[]{#__RefHeading___Toc29457_1669085364 .anchor}5.1.3. Exemple de JSON
...
[]{#__RefHeading___Toc29459_1669085364 .anchor}5.1.4. Détail des champs
...
-   Cardinalité : 0-1
    ...
    []{#__RefHeading___Toc29461_1669085364 .anchor}5.2. Collection
    AccessionRegisterDetail

    []{#__RefHeading___Toc29463_1669085364 .anchor}5.2.1. Utilisation de
...
que d’opérations d’entrées effectuées pour ce service producteur, mais
des évolutions sont d’ores et déjà prévues. Cette collection reprend les
éléments du bordereau de transfert, ainsi que les éléments correspondant
à des opérations d’élimination, de transfert ou de préservation.

[]{#__RefHeading___Toc29465_1669085364 .anchor}5.2.2. Exemple de la
...
[]{#__RefHeading___Toc29467_1669085364 .anchor}5.2.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs
...
[]{#__RefHeading___Toc29469_1669085364 .anchor}5.2.4. Détail des champs
...
**« Opi » :** identifiant de l’opération d’entrée ayant provoqué la
prise en charge dans le système des archives recensées dans ce détail du
registre des fonds
...
lot d’ingest existant.

-   Le premier événement contient les remained de l’opération d’ingest.

-   Les événements suivants concernent les opérations ayant modifié un
    > lot d’ingest existant (Elimination, Transfer…)
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc29471_1669085364 .anchor}5.3. Collection
    AccessionRegisterSummary

    []{#__RefHeading___Toc29473_1669085364 .anchor}5.3.1. Utilisation de
    la collection
...
[]{#__RefHeading___Toc29475_1669085364 .anchor}5.3.2. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs
...
[]{#__RefHeading___Toc29477_1669085364 .anchor}5.3.3. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc29479_1669085364 .anchor}5.4. Collection
    AccessionRegisterSymbolic

    []{#__RefHeading___Toc29481_1669085364 .anchor}5.4.1. Utilisation de
    la collection
...
[]{#__RefHeading___Toc29483_1669085364 .anchor}5.4.2. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc29485_1669085364 .anchor}5.5. Collection
    ArchiveUnitProfile

    []{#__RefHeading___Toc29487_1669085364 .anchor}5.5.1. Utilisation de
    la collection

La collection ArchiveUnitProfile permet de référencer et décrire
unitairement les profils d’unité archivistique.

[]{#__RefHeading___Toc29489_1669085364 .anchor}5.5.2. Exemple d’un
...
[]{#__RefHeading___Toc29491_1669085364 .anchor}5.5.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
ArchiveUnitProfile
...
[]{#__RefHeading___Toc29493_1669085364 .anchor}5.5.4. Détail des champs
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29495_1669085364 .anchor}5.6. Collection
    Agencies

    []{#__RefHeading___Toc29497_1669085364 .anchor}5.6.1. Utilisation de
...
[]{#__RefHeading___Toc29499_1669085364 .anchor}5.6.2. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
Agencies
...
[]{#__RefHeading___Toc29501_1669085364 .anchor}5.6.3. Détail des champs
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29503_1669085364 .anchor}5.7. Collection
    Context

    []{#__RefHeading___Toc29505_1669085364 .anchor}5.7.1. Utilisation de
    la collection

La collection Context permet de référencer et décrire unitairement les
contextes applicatifs.

[]{#__RefHeading___Toc29507_1669085364 .anchor}5.7.2. Exemple d’un
...
[]{#__RefHeading___Toc29509_1669085364 .anchor}5.7.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
Context
...
-   Permissions. La valeur de Permissions peut cependant être vide :
    ...
    []{#__RefHeading___Toc29511_1669085364 .anchor}5.7.4. Détail des
    champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc29513_1669085364 .anchor}5.8. Collection
    FileFormat

    []{#__RefHeading___Toc29515_1669085364 .anchor}5.8.1. Utilisation de
...
[]{#__RefHeading___Toc29517_1669085364 .anchor}5.8.2. Exemple de la
...
[]{#__RefHeading___Toc29519_1669085364 .anchor}5.8.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
FileFormat
...
[]{#__RefHeading___Toc29521_1669085364 .anchor}5.8.4. Détail des champs
du JSON stocké en base
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc29523_1669085364 .anchor}5.9. Collection
    FileRules

    []{#__RefHeading___Toc29525_1669085364 .anchor}5.9.1. Utilisation de
...
-   YEAR
    ...
    []{#__RefHeading___Toc29527_1669085364 .anchor}5.9.2. Exemple de
...
[]{#__RefHeading___Toc29529_1669085364 .anchor}5.9.3. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc12788_4022761242 .anchor}5.10. Collection
    Griffin

    []{#__RefHeading___Toc29577_1669085364 .anchor}5.10.1. Utilisation
...
[]{#__RefHeading___Toc13506_4022761242 .anchor}5.10.2. Exemple d’un
fichier d’import de griffon

Le référentiel des griffons estt importé dans la solution logicielle
Vitam sous la forme d’un fichier JSON.
...
[]{#__RefHeading___Toc29579_1669085364 .anchor}5.10.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
Agencies
...
[]{#__RefHeading___Toc29581_1669085364 .anchor}5.10.4. Détail des champs

**« \_id » :** identifiant unique faisant référence à un exécutable et à
sa version.
...
**« LastUpdate » :** date de dernière mise à jour du griffon dans la
collection Griffin.
...
**« ExecutableName » :** nom technique du griffon utilisé pour lancer
l’exécutable sur le système.
...
-   Un même exécutable (ExecutableName) peut être associé à plusieurs
    > versions.
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29531_1669085364 .anchor}5.11. Collection
    IngestContract

    []{#__RefHeading___Toc29533_1669085364 .anchor}5.11.1. Utilisation
    de la collection

La collection IngestContract permet de référencer et décrire
unitairement les contrats d’entrée.

[]{#__RefHeading___Toc29535_1669085364 .anchor}5.11.2. Exemple d’un
fichier d’import de contrat

Les contrats d’entrée sont importés dans la solution logicielle Vitam
sous la forme d’un fichier JSON.
...
-   Identifier (selon la configuration du tenant : Identifier n’est
    > obligatoire que si l’identifiant du contrat d’entrée n’est pas
    > généré par la solution logicielle Vitam)

Un fichier d’import peut décrire plusieurs contrats.

[]{#__RefHeading___Toc29537_1669085364 .anchor}5.11.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
IngestContract
...
[]{#__RefHeading___Toc29539_1669085364 .anchor}5.11.4. Détail des champs
de la collection IngestContract
...
-   Il est constitué du préfixe « IC- » suivi d’une suite de 6 chiffres
    > dans le cas ou la solution logicielle Vitam peuple l’identifiant.
    > Par exemple : IC-007485. Si le référentiel est en position
    > esclave, cet identifiant peut être géré par l’application à
    > l’origine du contrat.Cardinalité : 1-1
...
**« LastUpdate » :** date de dernière mise à jour du contrat dans la
collection IngestContract.
...
**« CheckParentLink » :** option permettant de définir le comportement à
propos des rattachements déclarés dans les SIP.

-   Si le SIP déclare un rattachement alors que cette déclaration n’est
    pas autorisée, l’entrée est en KO. De même, si le SIP ne déclare pas
    de rattachement alors que cette déclaration est obligatoire,
    l’entrée est en KO.

<!-- -->

-   Peut avoir comme valeur : « AUTHORIZED » (la déclaration d’un
    rattachement est autorisée, mais pas requise), « REQUIRED » (la
    déclaration d’un rattachement est obligatoire), « UNAUTHORIZED » (la
    déclaration d’un rattachement n’est pas autorisée).

-   Dans le fichier JSON du contrat à importer, ce champ peut être
    absent. Dans ce cas, il sera enregistré avec la valeur
    « AUTHORIZED » en base de données lors de l’import.

-   Cardinalité : 1-1

« ComputedInheritedRulesAtIngest » : activation de l’enregistrement
automatique des règles de gestion héritées en base de données.

-   Il s’agit d’un booléen.

-   Cardinalité : 0-1

**« LinkParentId » :** point de rattachement automatique des SIP en
application du contrat d’entrée correspondant à l’identifiant d’une
unité archivistique standard, de plan de classement ou d’arbre de
positionnement.

-   Il s’agit d’une chaîne de 36 caractères correspondant à un GUID et à
    > une valeur valide du champ \_id d’un enregistrement de la
    > collection Unit.

-   Cardinalité : 0-1

**« CheckParentId » :** option permettant d’activer un contrôle sur les
nœuds de rattachement déclarés dans le SIP.

-   Le nœud déclaré dans un SIP utilisant un contrat ayant cette
    variable doit impérativement être le nœud déclaré dans ce paramètre
    ou un de ses fils.

<!-- -->

-   Il s’agit d’une ou plusieurs chaînes de 36 caractères correspondant
    > à un GUID et à une valeur valide du champ \_id d’un enregistrement
    > de la collection Unit.

-   Cardinalité : 0-n

**« MasterMandatory » :** option qui rend obligatoire la présence d’un
objet dont l’usage est de type Master (Physical ou Binary).
...
-   Dans le fichier JSON du contrat à importer, ce champ peut être
    > absent. Dans ce cas, il sera enregistré avec la valeur « true » en
    > base de données lors de l’import.

-   Cardinalité : 1-1

**« EveryDataObjectVersion » :** option qui permet de préciser que tous
les types d’usages sont autorisés lors de l’entrée d’un SIP procédant à
des rattachements d’objets à des groupes d’objets techniques déjà
existants.
...
-   Si le champ a pour valeur « false », alors le champ
    > DataObjectVersion sera utilisé. S’il a pour valeur « true »,
    > « DataObjectVersion » sera ignoré.

-   Dans le fichier JSON du contrat à importer, ce champ peut être
    > absent. Dans ce cas, il sera enregistré avec la valeur
    > « INACTIVE » en base de données lors de l’import.

-   Cardinalité : 1-1

**« DataObjectVersion » :** liste les types d’usages autorisés lors de
l’entrée d’un SIP procédant à des rattachements d’objets à des groupes
d’objets techniques déjà existants. Les usages des objets rattachés
n’étant pas dans cette liste provoqueront une entrée en KO des SIP.

-   Il s’agit d’un tableau de chaîne de caractères.

-   Peut avoir comme valeur : « Dissemination », « TextContent »,
    > « PhysicalMaster », « BinaryMaster », « Thumbnail »

-   Dans le fichier JSON du contrat à importer, ce champ peut être
    > absent. Si le champ « EveryDataObjectVersion » a pour valeur
    > « true », ce champ sera ignoré.

-   Cardinalité : 0-1

**« FormatUnidentifiedAuthorized » :** option autorisant ou non l’entrée
d’objets dont le format n’est pas identifié par la solution logicielle
Vitam
...
-   Dans le fichier JSON du contrat à importer, ce champ peut être
    > absent. Dans ce cas, il sera enregistré avec la valeur « false »
    > en base de données lors de l’import.

-   Cardinalité : 1-1

**« EveryFormatType » :** option autorisant ou non l’entrée d’objets
...
-   Si ce champ a comme valeur « false », alors le champ « FormatType »
    > sera utilisé. S’il a comme valeur « true », alors le champ
    > « FormatType » sera ignoré.
...
**« FormatType » :** liste de PUID de formats de fichiers autorisés lors
de l’entrée d’un objet. Les objets n’étant pas dans cette liste de
format provoqueront une entrée KO de leurs SIP

-   Il s’agit d’un tableau de chaîne de caractères correspondant à des
    > identifiants valides du champ PUID de la collection FileFormat.

-   Si la variable EveryFormatType est à « true », ce champ sera ignoré.

-   Cardinalité : 0-1

    **« ManagementContractId » :** définition d’une stratégie de
    stockage dans le contrat d’entrée.

<!-- -->

-   Il s’agit d’une chaîne de caractères, correspondant à l’identifiant
    du contrat de gestion associé au contrat d’entrée.

-   Cardinalité : 0-1

    **« ArchiveProfiles » :** profil(s) d’archivage associé(s) contrat
    d’entrée.

-   Il s’agit d’un tableau pouvant contenir une à plusieurs chaînes de
    caractères, correspondant à l’identifiant de profil(s) d’archivage
    défini dans le référentiel des profils d’archivage.

-   Cardinalité : 0-1

    **« ComputeInheritedRulesAtIngest » :** paramètre permettant
    d’activer l’enregistrement automatique des règles de gestion
    héritées par une unité archivistique en base de données dans un
    champ spécifique.
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc18934_504739023 .anchor}5.12. Collection
    ManagementContract

    []{#__RefHeading___Toc29453_16690853641 .anchor}5.12.1. Utilisation
    de la collection ManagementContract

La collection ManagementContract permet de référencer et de décrire
unitairement les contrats de gestion.

[]{#__RefHeading___Toc29455_16690853641 .anchor}5.12.2. Exemple d’un
...
[]{#__RefHeading___Toc29457_16690853641 .anchor}5.12.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
ManagementContract
...
[]{#__RefHeading___Toc29459_16690853641 .anchor}5.12.4. Détail des
champs
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29541_1669085364 .anchor}5.13. Collection
    Ontology

    []{#__RefHeading___Toc29543_1669085364 .anchor}5.13.1. Utilisation
    de la collection
...
[]{#__RefHeading___Toc29545_1669085364 .anchor}5.13.2. Exemple d’un
...
[]{#__RefHeading___Toc29547_1669085364 .anchor}5.13.3. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc12790_4022761242 .anchor}5.14. Collection
    PreservationScenario

    []{#__RefHeading___Toc29585_1669085364 .anchor}5.14.1. Utilisation
...
[]{#__RefHeading___Toc13508_4022761242 .anchor}5.14.2. Exemple d’un
...
[]{#__RefHeading___Toc29587_1669085364 .anchor}5.14.3. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs de la collection
PreservationScenario
...
[]{#__RefHeading___Toc29589_1669085364 .anchor}5.14.4. Détail des champs
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29549_1669085364 .anchor}5.15. Collection
    Profile

    []{#__RefHeading___Toc29551_1669085364 .anchor}5.15.1. Utilisation
...
[]{#__RefHeading___Toc29553_1669085364 .anchor}5.15.2. Exemple d’un
...
-   Format
    ...
    []{#__RefHeading___Toc29555_1669085364 .anchor}5.15.3. Exemple de
    JSON stocké en base comprenant l’exhaustivité des champs de la
    collection Profile
...
[]{#__RefHeading___Toc29557_1669085364 .anchor}5.15.4. Détail des champs
...
-   Cardinalité : 0-1
    ...
    []{#__RefHeading___Toc29559_1669085364 .anchor}5.16. Collection
    SecurityProfile

    []{#__RefHeading___Toc29561_1669085364 .anchor}5.16.1. Utilisation
    de la collection

Cette collection référence et décrit les profils de sécurité mobilisés
par les contextes applicatifs.

[]{#__RefHeading___Toc29563_1669085364 .anchor}5.16.2. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs
...
[]{#__RefHeading___Toc29565_1669085364 .anchor}5.16.3. Détail des champs
...
-   0 correspond à l’enregistrement d’origine. Si le numéro est
    ...
    []{#__RefHeading___Toc29567_1669085364 .anchor}5.17. Collection
    VitamSequence

    []{#__RefHeading___Toc29569_1669085364 .anchor}5.17.1. Utilisation
    de la collection
...
[]{#__RefHeading___Toc29571_1669085364 .anchor}5.17.2. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs
...
[]{#__RefHeading___Toc29573_1669085364 .anchor}5.17.3. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc52402_236744635 .anchor}5.18. Collection
    Offset

    []{#__RefHeading___Toc29439_16690853641 .anchor}5.18.1. Utilisation
    de la collection
...
[]{#__RefHeading___Toc29441_16690853641 .anchor}5.18.2. Exemple de JSON
stocké en base comprenant l’exhaustivité des champs
...
[]{#__RefHeading___Toc29443_16690853641 .anchor}5.18.3. Détail des
champs
...
1.  []{#__RefHeading___Toc29591_1669085364 .anchor}6. Base Report
...
-   UpdateUnitReport
    ...
    []{#__RefHeading___Toc87217_939825479 .anchor}6.1. Collection
    AuditObjectGroup

    []{#__RefHeading___Toc29597_1669085364111 .anchor}6.1.1. Utilisation
    de la collection
...
[]{#__RefHeading___Toc87219_939825479 .anchor}6.1.2. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc87221_939825479 .anchor}6.2. Collection
    EliminationActionUnit

    []{#__RefHeading___Toc29597_1669085364 .anchor}6.2.1. Utilisation de
    la collection
...
[]{#__RefHeading___Toc29599_1669085364 .anchor}6.2.2. Détail des champs
...
## Annexe 6.3 Collection EliminationActionObjectGroup
    ...
    []{#__RefHeading___Toc29603_1669085364 .anchor}6.3.1. Utilisation de
    la collection
...
[]{#__RefHeading___Toc29605_1669085364 .anchor}6.3.2. Détail des champs
...
-   Cardinalité : 1-1
    ...
    []{#__RefHeading___Toc12792_4022761242 .anchor}6.4. Collection
    PreservationReport

    []{#__RefHeading___Toc29603_16690853641 .anchor}6.4.1. Utilisation
    de la collection
...
[]{#__RefHeading___Toc29605_16690853641 .anchor}6.4.2. Détail des champs
...
1.  []{#__RefHeading___Toc29607_1669085364 .anchor}7. Annexes

    []{#__RefHeading___Toc29609_1669085364 .anchor}7.1. Valeurs
...
[]{#__RefHeading___Toc29611_1669085364 .anchor}7.2. Valeurs possibles
pour le champ evType du LogBook LifeCycle

L’ensemble des étapes, tâches et traitements sont détaillées dans la
documentation Modèle de workflow.

[]{#__RefHeading___Toc29613_1669085364 .anchor}7.3. Valeurs possibles
pour le champ evTypeProc (type de processus)
...
[]{#__RefHeading___Toc29615_1669085364 .anchor}7.4. Catégories de règles
possibles
...
[]{#__RefHeading___Toc29617_1669085364 .anchor}7.5. Valeurs possibles
pour le champ Status de la collection AccessionRegisterDetail
...
[]{#__RefHeading___Toc29619_1669085364 .anchor}7.6. Valeurs possibles
pour le champ Name de la collection VitamSequence
...
[]{#__RefHeading___Toc29621_1669085364 .anchor}7.7. Type d’indexation
des chaînes de caractères dans ElasticSearch par collection et par champ
...
[]{#__RefHeading___Toc29623_1669085364 .anchor}7.8. Correspondances des
champs spéciaux dans Vitam
...
**Collection ObjectGroup**
  ...
  \#nbobjects               \_nbc
  \#originating\_agency     \_sp
  \#originating\_agencies   \_sps
  \#unitups                 \_up
  \#storage                 \_storage
  \#operations              \_ops
  \#opi                     \_opi
